...
const _sfc_main = {
  ...
  computed: {
    ...
    hasMoreLocations() {
      return this.timelineLocations.length > 1;
    },
    latestLocation() {
      return this.timelineLocations[0] || null;
    },
  ...
  methods: {
    ...
    async buildRoute() {
      ...
      try {
        ...
        const result = await common_vendor.api.amapDrivingRoute({
    ...
    openRecordsPanel() {
      if (!this.timelineLocations.length)
        return;
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    o: $options.hasMoreLocations
  }, $options.hasMoreLocations ? {
    p: common_vendor.o((...args) => $options.openRecordsPanel && $options.openRecordsPanel(...args), "63")
  } : {}, {
    q: $data.routeError
  }, $data.routeError ? {
    r: common_vendor.t($data.routeError)
  } : {}, {
    s: $options.latestLocation
  }, $options.latestLocation ? common_vendor.e({
    t: common_vendor.t($options.latestLocation.cityName || "在途位置"),
    v: common_vendor.t($options.dateText($options.latestLocation.createdAt)),
    w: common_vendor.t($options.latestLocation.address || "-"),
    x: $options.latestLocation.remark
  }, $options.latestLocation.remark ? {
    y: common_vendor.t($options.latestLocation.remark)
  } : {}, {
    z: common_vendor.o((...args) => $options.openRecordsPanel && $options.openRecordsPanel(...args), "f6")
  }) : {}, {
    A: $data.recordsPanelOpen
  }, $data.recordsPanelOpen ? {
    B: common_vendor.t($options.timelineLocations.length),
    C: common_vendor.o((...args) => $options.closeRecordsPanel && $options.closeRecordsPanel(...args), "b9"),
    D: common_vendor.f($options.timelineLocations, (loc, idx, i0) => {
      return common_vendor.e({
