...
const _sfc_main = {
  ...
  methods: {
    ...
    searchPoiAddresses(keyword, options = {}) {
      ...
      return common_vendor.api.amapPoiSearch({
    ...
    reverseGeocodeAddress(lng, lat) {
      ...
      return common_vendor.api.amapRegeo({ lng, lat }).then((data) => data.item ? this.normalizePoiAddress(data.item) : null).catch(() => null);
    },
